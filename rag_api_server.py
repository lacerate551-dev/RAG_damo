...
路由文件清单:
  api/chat_routes.py      → /chat, /rag, /rag/stream, /search
  api/session_routes.py   → /sessions, /history, /session, /clear
  api/auth_routes.py      → /stats, /health, /auth/me
  api/audit_routes.py     → /audit/logs
  api/kb_routes.py        → /collections, /documents/sync, /kb/route
  api/document_routes.py  → /documents/upload, /documents/list, /documents/*, 版本管理
  api/sync_routes.py      → /sync, /subscribe, /subscriptions, /notifications
  api/graph_routes.py     → /graph/search, /graph/build, /graph/stats
  api/question_routes.py  → /questions/*, /knowledge-points, /exam/*/analyze, /analysis/*
  api/outline_routes.py   → /outline/*, /recommend/*
  api/feedback_routes.py  → /feedback/*, /reports/*, /faq/*
"""

...
# 可选解析器的可用性标志（由 parsers/__init__.py 管理）
...
# ========== BM25索引管理器 ==========
# BM25Index 已迁移到 core/bm25_index.py
...
# ========== 文档处理函数 ==========
# 解析器函数已迁移到 parsers/ 包，这里导入以保持兼容
from parsers import (
    extract_text_from_pdf,
    extract_text_from_docx,
    extract_text_from_xlsx,
    extract_text_from_xlsx_traditional,
...
# split_text 已迁移到 core/chunker.py
